...
type JobFormDraft = Omit<JobFormPayload, "position_id" | "location_id" | "salary_min" | "salary_max" | "source_url"> & {
  position_id: number | "";
  location_id: number | "";
  salary_min: number | "";
  salary_max: number | "";
...
function buildFormValues(job: Job | null, draft?: Partial<JobFormPayload> | null): JobFormDraft {
  if (job) {
    return {
